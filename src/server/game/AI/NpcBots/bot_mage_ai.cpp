...
enum MageBaseSpells
{
    ...
    SUMMON_WATER_ELEMENTAL_1            = 60512
};
    ...
    struct mage_botAI : public bot_ai
    {
        ...
        void DoNormalAttack(uint32 diff)
        {
            ...
            if (fbCasted && IsSpellReady(DEEP_FREEZE_1, diff) && dist < CalcSpellMaxRange(DEEP_FREEZE_1) && Rand() < 30 &&
                opponent->IsImmunedToSpellEffect(sSpellMgr->GetSpellInfo(DEEP_FREEZE_1), 0) && (opponent->isFrozen() || me->HasAuraType(SPELL_AURA_ABILITY_IGNORE_AURASTATE)))
            {
        ...
        void SummonBotPet()
        {
            ...
            me->GetNearPoint(myPet, pos.m_positionX, pos.m_positionY, pos.m_positionZ, 2, 0.0f, me->GetOrientation());
