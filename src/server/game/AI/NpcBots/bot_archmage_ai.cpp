...
public:
    ...
    struct archmage_botAI : public bot_ai
    {
        ...
        void SummonBotPet()
        {
            ...
            Creature* myPet = me->SummonCreature(entry, *me, TEMPSUMMON_TIMED_OR_CORPSE_DESPAWN, (IAmFree() ? 60 : 1));
            me->GetNearPoint(myPet, pos.m_positionX, pos.m_positionY, pos.m_positionZ, 2.0f, 0.f, me->GetOrientation());
        ...
        void OnBotEnterVehicle(Vehicle * vehicle) override
        {
            me->Dismount();
