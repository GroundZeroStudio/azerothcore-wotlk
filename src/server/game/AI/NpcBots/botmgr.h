...
class BotMgr
{
    public:
        ...
        static void OnBotEnterVehicle(Creature const* passenger, Vehicle * vehicle);
        static void OnBotExitVehicle(Creature const* passenger, Vehicle * vehicle);
        ...
        int32 GetHPSTaken(Unit * unit) const;
