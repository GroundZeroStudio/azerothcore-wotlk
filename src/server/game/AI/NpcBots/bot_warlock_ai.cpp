    ...
    struct warlock_botAI : public bot_ai
    {
            ...
            if (!IAmFree() && hasSoulstone && soulstoneTimer <= diff && GetSpell(CREATE_SOULSTONE_1))
            {
                ...
                if (u)
                {
                    ...
                    switch (spellInfo->Id)
                    {
                        ...
                        default:
                            LOG_ERROR("entities.player", "bot_warlockAI: unknown soulstone Id %u", spellInfo->Id);
        ...
        void UpdateAI(uint32 diff) override
        {
                ...
                /*GetSpell(CREATE_HEALTHSTONE_1) && */!IsCasting() && GetHealthPCT(me) < 65)
            {
                ...
                me->CastSpell(me, _healthStoneSpells[rank - 1], true);
        ...
        void SpellHit(Unit* caster, SpellInfo const* spell) override
        {
            ...
            if (baseId == LIFE_TAP_1)
            {
                ...
                me->CastSpell(me, LIFE_TAP_ENERGIZE, false);
        ...
        void SummonBotPet()
        {
            ...
            me->GetNearPoint(myPet, pos.m_positionX, pos.m_positionY, pos.m_positionZ, 0, 0.0f, me->GetOrientation() + M_PI / 2);
