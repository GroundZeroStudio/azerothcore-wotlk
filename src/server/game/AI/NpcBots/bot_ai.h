...
class bot_ai : public CreatureAI
{
    public:
        ...
        virtual void OnBotEnterVehicle(Vehicle * vehicle);
        virtual void OnBotExitVehicle(Vehicle * vehicle);
    ...
    protected:
        ...
        uint32 GetDPSTaken(Unit * u) const;
        int32 GetHPSTaken(Unit * u) const;
        int32 GetHPS(Unit * u) const;
        int32 GetHPPCTPS(Unit * u) const;
        uint8 GetExpectedHPPCT(Unit * u, uint32 mseconds) const;
