...
//Talents
    ...
    THRILL_OF_THE_HUNT                  = 53292,//rank 3
...
public:
    ...
    struct hunter_botAI : public bot_ai
    {
        ...
        void OnClassSpellGo(SpellInfo const* spellInfo) override
        {
            ...
            if (baseId == ARCANE_SHOT_1)
            {
                    ...
                    victim->GetAuraEffect(SPELL_AURA_PERIODIC_DAMAGE, SPELLFAMILY_HUNTER, 0x0, 0x100, 0x0, me->GetGUID())))
                {
                    ...
                    me->CastSpell(me, GLYPH_OF_ARCANE_SHOT_ENERGIZE, true);
                }
            }
        ...
        void SummonBotPet()
        {
            ...
            me->GetNearPoint(myPet, pos.m_positionX, pos.m_positionY, pos.m_positionZ, 0, 0, me->GetOrientation() + M_PI / 2);
