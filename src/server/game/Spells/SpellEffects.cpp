            ...
            case SPELLFAMILY_HUNTER:
                {
                    ...
                    else if (m_spellInfo->SpellFamilyFlags[1] & 0x1)
                    {
                        ...
                        if (Player* caster = m_caster->ToPlayer())
                        {
                            ...
                            if (Item* item = caster->ToCreature()->GetBotEquips(2/*BOT_SLOT_RANGED*/))
                             {
                            ...
                            dmg_max += weaponTemplate->Damage[i].DamageMax;
                             ...
                             damage += irand(int32(dmg_min), int32(dmg_max));
                            damage += int32(caster->ToCreature()->GetCreatureAmmoDPS() * weaponTemplate->Delay * 0.001f);
                            }
                             }
                             #endif
                        }
...
void Spell::EffectTriggerSpell(SpellEffIndex effIndex)
{
            ...
            && effectHandleMode == SPELL_EFFECT_HANDLE_LAUNCH_TARGET)
    {
        ...
        unitTarget->CastSpell(unitTarget, triggered_spell_id, false);
        return;
        }
         default:
        break;
